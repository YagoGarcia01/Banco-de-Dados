...
insert into tbAlunos(nome) values("Yago Urias de Souza Garcia");  
...
insert into tbAlunos(nome) values("Giovanni Urias"); 
insert into tbdisciplinas(disciplina, id_aluno) values("Filosofia", 2);
